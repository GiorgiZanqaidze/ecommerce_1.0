...
export class OrdersController {
  ...
  @Get(':id')
  getOrder(@Param('id') id: string) { // id is received as string from route parameters
  ...
  @Get('user/:userId')
  getOrdersByUser(@Param('userId') userId: string) { // userId is received as string from route parameters
